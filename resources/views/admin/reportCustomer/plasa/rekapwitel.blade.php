                                        ...
                                        <table class="table table-bordered text-center">
                                            <thead>
                                                <tr>                                   
                                                    ...
                                                    <th class="align-middle">PSB 2P</th>    
                                                    <th class="align-middle">PSB 3P</th>                                                
                ...
                $.each(data.rekapwitel, function(index,value){  
                    ...
                    $('#csr-plasa').append(`
                        <tr>
                            ...
                            <td> 
                                <a style="color: black" target="_blank" href="{{url('admin/performance/plasa/rekap/detail/' . '`+periode+`' . '/' . '`+witel+`' . '/' . '`+value.plasa+`' . '/' . 'psb_2p')}}">`+getNumber(value.psb_2p)+`</a>                                
                            </td>                           
                            <td> 
                                <a style="color: black" target="_blank" href="{{url('admin/performance/plasa/rekap/detail/' . '`+periode+`' . '/' . '`+witel+`' . '/' . '`+value.plasa+`' . '/' . 'psb_3p')}}">`+getNumber(value.psb_3p)+`</a>                                
                            </td> 
                            <td> 
