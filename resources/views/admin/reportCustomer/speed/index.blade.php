            ...
            'success': function(data) {    
                ...
                $.each(data.datatable, function(index,value){                                      
                    ...
                    <tr>
                        ...
                        <td>`+getNumber(value.a_blank)+`</td>
                        <td>`+getNumber(value.b_512)+`</td>
                        <td>`+getNumber(value.c_1024)+`</td>
                        <td>`+getNumber(value.d_2048)+`</td>
                        <td>`+getNumber(value.e_3072)+`</td>
                        <td>`+getNumber(value.f_5120)+`</td> 
                        <td>`+getNumber(value.g_10240)+`</td>
                        <td>`+getNumber(value.h_20480)+`</td>
                        <td>`+getNumber(value.i_30720)+`</td>
                        <td>`+getNumber(value.j_40960)+`</td>
                        <td>`+getNumber(value.k_51200)+`</td>
                        <td>`+getNumber(value.l_102400)+`</td>
                        <td>`+getNumber(value.m_204800)+`</td>
                        <td>`+getNumber(value.n_307200)+`</td>
                    </tr>`)
                });
            }
        })
