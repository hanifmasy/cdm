...
<div class="card">
	<div class="card-body">
		<h4 class="card-title">{{ trans('cruds.userAlert.title_singular') }} {{ trans('global.list') }}</h4>
		<div class="row">
			<div class="col-12">
				<div class="table-responsive">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-UserAlert" id="order-listing" style="width: 100%;">
                        <thead>
                            <tr>
                                <th width="10">
