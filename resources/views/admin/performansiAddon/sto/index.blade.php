...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.performansi_addon.title_singular') }} STO {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <form id="filterPerform" type="POST" action="{{route('admin.performSto.index')}}"
            ...
            <div class="form-group row">
                <label for="sto" class="col-md-2 col-form-label">Filter STO</label>
                <div class="col-sm-6 controls">
                    <input class="form-control" type="text" name="filterSto" id="filterSto" placeholder="STO">
                </div>
            </div>

            <div class="form-group row">
                <label for="report_month" class="col-md-2 col-form-label">Filter Kaubis</label>
                <div class="col-sm-6 controls">
...
<script>
    $(document).ready(function () {
        ...
        function fill_datatable(filter_startDate = '', filter_endDate = '', filter_witel = '', filter_kaubis = '', filter_sto) {
        ...
        $('#searchBtn').click(function (e) {
            ...
            if (filter_startDate != '' && filter_endDate == '') {
                ...
                fill_datatable(filter_startDate, filter_endDate, filter_witel, filter_kaubis, filter_sto);
            }
        });
